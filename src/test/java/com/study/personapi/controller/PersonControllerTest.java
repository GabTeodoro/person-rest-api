...
import static com.study.personapi.utils.PersonUtils.asJsonString;
...
public class PersonControllerTest {
    ...
    void testWhenGETWithValidIsCalledThenAPersonShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(PEOPLE_API_URL_PATH + "/" + expectedValidId).contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.lastName", is("Shelby")));
    }
    ...
    void testWhenGETIsCalledThenPeopleListShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(PEOPLE_API_URL_PATH).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id", is(1)))
                .andExpect(jsonPath("$[0].firstName", is("Thomas")))
                .andExpect(jsonPath("$[0].lastName", is("Shelby")));
    }
